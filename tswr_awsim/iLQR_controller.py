...
class iLQRNode(Node):
    ...
    def cost_stage(self, x, u):
        ...
        if self.ref_path != None:
            ...
            return 1 * c_traj_x + 1 * c_traj_y + c_vel + 0.1 * c_traj_yaw + c_control
    ...
    def cost_final(self, x):
        ...
        if self.ref_path != None:
            ...
            return 1 * c_traj_x + 1 * c_traj_y + 0.1 * c_traj_yaw + c_vel
    ...
    def run_ilqr(self, x0, N, max_iter=50, regu_init=100):
        ...
        for it in range(max_iter):
            ...
            if cost_redu > 0:
                # If improvement accept new trajectories and lower regularization
